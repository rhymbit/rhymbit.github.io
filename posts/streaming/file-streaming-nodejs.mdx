---
title: Streaming files with NodeJS
description: A super easy way to stream large files using NodeJs and ExpressJs packaged as a standalone executable.
pubDate: 2024-05-19
tags: ["nodejs", "expressjs", "streaming"]
socialImage:
  filepathPublic: "/images/posts/nodejs-file-streaming.jpg"
  alt: "Streaming files with NodeJS"
---
...
- It doesn’t just stream large files, it can **stream/send any file** be it large or small 😊.
- On frontend side, all you gotta do is use simple fetch api 🤷🏻‍♂️, no fancy sh*t required.
...
- **NodeJs version 21+** has the ability to create single executables, but currently it’s an experimental feature.  
- So you kinda have to write your code in CommonJs module system, because that’s the only thing that’s supported at the moment.  
...
/* 
More about these 2 👇🏻 in Bonus section
...
Just follow the steps in the [NodeJs Single Executable](/nodejs-standalone-executable) post and you’re good to go 🚀.

Here’s some scripts you can use in your package.json to make your life easier 😮‍💨. 
...
```
 ...
 and wondering what tf is that all bout 🤨 :-

- If you package your app as a standalone executable, and want to stream files 
  from the current directory where the executable is; Why 🤨? :-
- Because your app isn’t installable but is actually portable, then consider using 
  these 2 routers 👇🏻 (because I use them in my projects all the time)
